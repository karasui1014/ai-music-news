 ...
 * data/news.json にまとめます。外部ライブラリは一切使いません（Node 18+ の標準機能のみ）。
 *
...
const OUT_PATH = join(ROOT, 'data', 'news.json');
...
const RANKING_SIZE = 10;           // 注目ランキングに出す件数（これ以上は出さない）
